export const gapCards = [
    ...
    "Was brachte die Orgie zu einem schlagartigen Stillstand? ___",
    ...
    "Woher kommt der Fleck auf meiner Couch? ___",
    ...
    "Wie kompensiere ich für meinen winzigen Penis? ___",
    ...
    "Was hat zum Ende meiner letzten Beziehung geführt? ___",
    "Für was hältst du mich eigentlich? ___",
    "Um mehr Besucher anzulocken, hat das Deutsche Museum eine interaktive Ausstellung über ___ eröffnet.",
    "Papa, warum weint Mama? ___",
